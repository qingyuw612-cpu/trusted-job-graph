...
def main() -> None:
    ...
    parser.add_argument("--base-url", default=os.getenv("ABILITY_LLM_BASE_URL", ""))
    parser.add_argument("--api-key", default=os.getenv("ABILITY_LLM_API_KEY", ""))
    parser.add_argument("--model", default=os.getenv("ABILITY_LLM_MODEL", ""))
    ...
    if not args.base_url or not args.model:
        raise ValueError("请提供 --base-url 和 --model，或设置 ABILITY_LLM_BASE_URL/ABILITY_LLM_MODEL。")
